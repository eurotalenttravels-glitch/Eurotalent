  ...
  return (
    <div className="min-h-screen bg-[#fbfbfd]">
      ...
      <a
        ...
        className="fixed bottom-20 sm:bottom-24 right-4 sm:right-6 bg-[#25D366] text-white w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center shadow-apple hover:shadow-apple-hover hover:bg-[#20ba5a] transition-all active:scale-95 z-40"
      >
