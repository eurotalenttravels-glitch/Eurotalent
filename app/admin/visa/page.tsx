    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-6 sm:mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Visa Data Manager</h1>
            <p className="text-sm sm:text-base text-gray-600">Complete control: Add, Edit, Delete visa data, types, and entries</p>
          </div>
